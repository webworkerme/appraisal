  ...
  <div>
    ...
    <Row class="body-pad" type="flex" align="middle" justify="center">
      ...
      >
        ...
        <ellipse cx="262.87" cy="734.89" rx="218" ry="15.5" fill="#6c63ff" opacity="0.1"></ellipse>
        <path
        ...
        <path
          ...
          fill="#3f3d56"
        ></path>
        <rect x="544.69" y="243.47" width="20.12" height="21.18" fill="#3f3d56"></rect>
        <rect
          x="689.04"
          y="330.53"
          width="20.12"
        ...
        <rect
          ...
          fill="#3f3d56"
        ></rect>
        <rect x="544.69" y="434.11" width="20.12" height="21.18" fill="#3f3d56"></rect>
        <rect
          x="689.04"
          y="496.66"
          width="20.12"
        ...
        <rect
          ...
          fill="#3f3d56"
        ></rect>
        <rect x="449.38" y="340.91" width="24.36" height="18" fill="#3f3d56"></rect>
        <rect
          x="736.3"
          y="415.71"
          width="24.36"
        ...
        <path
          ...
          fill="#3f3d56"
        ></path>
        <rect x="704.61" y="119.57" width="20.12" height="21.18" fill="#3f3d56"></rect>
        <rect
          x="848.96"
          y="206.62"
          width="20.12"
        ...
        <rect
          ...
          fill="#3f3d56"
        ></rect>
        <rect x="704.61" y="310.2" width="20.12" height="21.18" fill="#3f3d56"></rect>
        <rect
          x="848.96"
          y="372.75"
          width="20.12"
        ...
        <rect
          ...
          fill="#3f3d56"
        ></rect>
        <rect x="609.29" y="217" width="24.36" height="18" fill="#3f3d56"></rect>
        <rect
          x="896.21"
          y="291.8"
          width="24.36"
        ...
        <path
          ...
          opacity="0.1"
        ></path>
        <circle cx="183.27" cy="227.74" r="36.6" fill="#fbbebe"></circle>
        <path
